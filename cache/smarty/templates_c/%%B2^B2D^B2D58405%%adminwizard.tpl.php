<?php /* Smarty version 2.6.11, created on 2011-06-03 11:27:55
         compiled from modules/Configurator/tpls/adminwizard.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'overlib_includes', 'modules/Configurator/tpls/adminwizard.tpl', 47, false),array('function', 'sugar_getjspath', 'modules/Configurator/tpls/adminwizard.tpl', 66, false),array('function', 'sugar_help', 'modules/Configurator/tpls/adminwizard.tpl', 119, false),array('function', 'sugar_translate', 'modules/Configurator/tpls/adminwizard.tpl', 160, false),array('function', 'html_options', 'modules/Configurator/tpls/adminwizard.tpl', 168, false),array('function', 'sugar_getimagepath', 'modules/Configurator/tpls/adminwizard.tpl', 382, false),)), $this); ?>
...
: </td>
                    <td>
                        <input onkeyup="setPreview();" size='15' onkeydown="setPreview();" id="default_locale_name_format" type="text" name="default_locale_name_format" value="<?php echo $this->_tpl_vars['config']['default_locale_name_format']; ?>
">
                        <br>
                        <?php echo smarty_function_sugar_translate(array('module' => 'Administration','label' => 'LBL_LOCALE_NAME_FORMAT_DESC'), $this);?>

                    </td>
                    <td nowrap="nowrap" scope="row" valign="top"><?php echo smarty_function_sugar_translate(array('module' => 'Administration','label' => 'LBL_LOCALE_EXAMPLE_NAME_FORMAT'), $this);?>
: </td>
...
'); document.getElementById('AdminWizard').mail_smtptype.value = 'gmail';" />
    </div>
</div>
                        ...
                        <span id="other" class="yui-button yui-radio-button<?php if ($this->_tpl_vars['mail_smtptype'] == 'other' || empty ( $this->_tpl_vars['mail_smtptype'] )): ?> yui-button-checked<?php endif; ?>">
                            <span class="first-child">
                                <button type="button" name="mail_smtptype" value="other">
                                    &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $this->_tpl_vars['APP']['LBL_TABGROUP_OTHER']; ?>
&nbsp;&nbsp;&nbsp;&nbsp;
                                </button>
                            </span>
                        </span>
...
&nbsp;
									<img border="0" onmouseout="return nd();" onmouseover="return overlib('<?php echo $this->_tpl_vars['MOD']['LBL_ALLOW_DEFAULT_SELECTION_HELP']; ?>
', FGCLASS, 'olFgClass', CGCLASS, 'olCgClass', BGCLASS, 'olBgClass', TEXTFONTCLASS, 'olFontClass', CAPTIONFONTCLASS, 'olCapFontClass', CLOSEFONTCLASS, 'olCloseFontClass', WIDTH, -1, NOFOLLOW, 'ol_nofollow')" src="index.php?entryPoint=getImage&themeName=<?php echo $this->_tpl_vars['THEME']; ?>
